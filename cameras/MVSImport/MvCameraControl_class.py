...
# MvCamCtrldll = WinDLL(
#     r"E:\github\ag_oqc_heaphone\cameras\MVSImport\MvCameraControl.dll"
# )
...
class MvCamera:
    ...
    def MV_CC_GetBoolValue(self, strKey, BoolValue):
        ...
        return MvCamCtrldll.MV_CC_GetBoolValue(
            self.handle, strKey.encode("ascii"), BoolValue
        )
    ...
    def MV_CC_EnumDevicesEx(nTLayerType, stDevList, strManufacturerName):
        ...
        return MvCamCtrldll.MV_CC_EnumDevicesEx(
            c_uint(nTLayerType), byref(stDevList), byref(strManufacturerName)
        )
    ...
    def MV_CC_IsDeviceAccessible(self, stDevInfo, nAccessMode):
        ...
        return MvCamCtrldll.MV_CC_IsDeviceAccessible(
            byref(stDevInfo), c_uint(nAccessMode)
        )
    ...
    def MV_CC_GetImageForRGB(self, pData, nDataSize, stFrameInfo, nMsec):
        ...
        return MvCamCtrldll.MV_CC_GetImageForRGB(
            self.handle, pData, nDataSize, byref(stFrameInfo), c_uint(nMsec)
        )
    ...
    def MV_CC_GetImageBuffer(self, pstFrame, nMsec):
        ...
        return MvCamCtrldll.MV_CC_GetImageBuffer(
            self.handle, byref(pstFrame), c_uint(nMsec)
        )
    ...
    def MV_CC_SetOutputQueueSize(self, nOutputQueueSize):
        ...
        return MvCamCtrldll.MV_CC_SetOutputQueueSize(
            self.handle, c_uint(nOutputQueueSize)
        )
    ...
    def MV_CC_GetIntValueEx(self, strKey, pstIntValue):
        ...
        return MvCamCtrldll.MV_CC_GetIntValueEx(
            self.handle, byref(strKey), byref(pstIntValue)
        )
    ...
    def MV_CC_ReadMemory(self, pBuffer, nAddress, nLength):
        ...
        return MvCamCtrldll.MV_CC_ReadMemory(
            self.handle, pBuffer, c_uint(nAddress), c_uint(nLength)
        )
    ...
    def MV_CAML_GetDeviceBauderate(self, pnCurrentBaudrate):
        ...
        return MvCamCtrldll.MV_CAML_GetDeviceBauderate(
    ...
    def MV_CAML_GetSupportBauderates(self, pnBaudrateAblity):
        ...
        return MvCamCtrldll.MV_CAML_GetSupportBauderates(
    ...
    def MV_CC_EnumInterfacesByGenTL(self, pstIFList, strGenTLPath):
        ...
        return MvCamCtrldll.MV_CC_EnumInterfacesByGenTL(
            byref(pstIFList), strGenTLPath.encode("ascii")
        )
    ...
    def MV_CC_EnumDevicesByGenTL(self, pstIFInfo, pstDevList):
        ...
        return MvCamCtrldll.MV_CC_EnumDevicesByGenTL(
            byref(pstIFInfo), byref(pstDevList)
        )
    ...
    def MV_CC_CreateHandleByGenTL(self, pstDevInfo):
        ...
        return MvCamCtrldll.MV_CC_CreateHandleByGenTL(
            byref(self.handle), byref(pstDevInfo)
        )
    ...
    def MV_XML_GetGenICamXML(self, pData, nDataSize, pnDataLen):
        ...
        return MvCamCtrldll.MV_XML_GetGenICamXML(
            self.handle, byref(pData), c_uint(nDataSize), byref(pnDataLen)
        )
    ...
    def MV_CC_SavePointCloudData(self, pstPointDataParam):
        ...
        return MvCamCtrldll.MV_CC_SavePointCloudData(
            self.handle, byref(pstPointDataParam)
        )
